...
function sleepIn(weekday, vacation) {
    if (weekday === false && vaction === false){
      return true
    } else if ( weekday && vaction === false ){
      return false
    } else if (weekday === false && vacation == true){
      return true
    } else if (weekday && vaction){
      return true
    }
}
...
function monkeyTrouble(aSmile, bSmile) {
    if (asmile && bsmile){
      return true
    } else if (amsile == false && bsmile == false){
      return true
    } else {
      return false
    }
...
var output = stringTimes("simon", 22);
console.log (output);
...
output=caught_speeding(61,false)
console.log("caugt " + output)
function caught_speeding(speed, is_birthday){
  //Code Goes Here
  if (speed >= 61 && speed <= 80 && !is_birthday){
    return 1
  } 
  else if ( speed >= 81 && !is_birthday){
    return 2
  }
  else if (speed <= 86 && is_birthday){
    return 0
  }
  else {
    return 0
